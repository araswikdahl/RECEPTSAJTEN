...
const IngredienserContent = styled.div`
width:50%;
padding:2.5rem;
h3{
    font-size:30px;
...
const GörsåhärContent = styled.div`
width:50%;
padding:2.5rem;
h3{
    font-size:30px;
        ...
        <Main>
            {recipe &&
                ...
                <RecipeWrapper>
                    ...
                    <GörsåhärContent>
                        <h3>Gör såhär</h3>
                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dicta odio corporis nihil iure omnis accusamus quasi, numquam dolorem? Praesentium a aut at necessitatibus maxime. Sint consectetur voluptatum mollitia reiciendis fugiat!</p>
                    </GörsåhärContent>
                </RecipeWrapper>
            }
        </Main>
